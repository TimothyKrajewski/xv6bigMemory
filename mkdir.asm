...
0000046a <printf>:
 ...
 544:	c7 45 f4 51 08 00 00 	movl   $0x851,-0xc(%ebp)
...
free(void *ap)
{
 ...
 6d4:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 6d9:	c9                   	leave  
 6da:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 731:	83 c4 10             	add    $0x10,%esp
  return freep;
 734:	a1 c0 0a 00 00       	mov    0xac0,%eax
}
 739:	c9                   	leave  
 73a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75e:	c7 45 f0 b8 0a 00 00 	movl   $0xab8,-0x10(%ebp)
 765:	8b 45 f0             	mov    -0x10(%ebp),%eax
 768:	a3 c0 0a 00 00       	mov    %eax,0xac0
 76d:	a1 c0 0a 00 00       	mov    0xac0,%eax
 772:	a3 b8 0a 00 00       	mov    %eax,0xab8
    base.s.size = 0;
 777:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 77e:	00 00 00 
  }
 ...
 7d4:	a3 c0 0a 00 00       	mov    %eax,0xac0
      return (void*)(p + 1);
 ...
 7df:	eb 3b                	jmp    81c <malloc+0xe1>
    ...
    if(p == freep)
 7e1:	a1 c0 0a 00 00       	mov    0xac0,%eax
